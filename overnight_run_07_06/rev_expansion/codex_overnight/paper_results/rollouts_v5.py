...
import grid_metrics2 as GM2  # noqa: E402  (goal-relative staircase; GM.staircase_id is (5,5)-frame → None at 4.7)
...
OURS_DIR = "results/p2/eval_faithful_div_it100"   # diversity-preserving run (anchor+T350+inner4): BALANCED R/U modes
...
ABL = [("results/p2/eval_faithbro_div_nosocp", "NO safety validity check"),
       ("results/p2/eval_faithbro_div_noprog", "NO progress check"),
       ("results/p2/eval_faithbro_div_nocur", "NO curriculum")]
...
def main():
    ...
    for ext in ("png", "pdf"):
        fig.savefig(os.path.join(HERE, f"rollouts_v5.{ext}"), dpi=135, bbox_inches="tight")
    print("wrote rollouts_v5.png/.pdf")

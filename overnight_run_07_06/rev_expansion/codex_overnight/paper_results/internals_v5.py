...
RUN = os.path.join(P2, "results/p2/faithful_div_it100")   # fresh it0→100 window-level run (2026-07-15)
...
def main():
    ...
    fig.tight_layout()
    for ext in ("png", "pdf"):
        fig.savefig(os.path.join(HERE, f"internals_v5.{ext}"), dpi=135, bbox_inches="tight")
    print("wrote internals_v5.png/.pdf")

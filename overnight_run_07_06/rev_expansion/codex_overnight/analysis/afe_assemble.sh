...
ARMS=${@:-"A_s910 B_s910 A2lam10_s910"}
...
CUDA_VISIBLE_DEVICES="" python analysis/afe_report.py \
  --arms results/afe/A_s910 results/afe/B_s910 results/afe/A2lam10_s910 \
  --labels A-minimal B+demo A2-lam10 --upfrac --out paper_results/afe_validity_v1.png | tail -n 1
for a in $ARMS; do

...
Output: `results/benchmark_videos/mirror_tuned_vs_mizuta.mp4`
...
- safemppi_use_sets_backup: `False`
...
```bash
for stem in v2_episode_set_a v2_episode_set_b; do
  conda run --live-stream -n cfm_mppi python -m cfm_mppi.evaluation.render_validation_comparison \
    --dataset ucy \
    --dynamics doubleintegrator \
    --pedestrian-source validation \
